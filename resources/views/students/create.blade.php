                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                <label for="number"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Number</label>
                            ...
                            <div class="mb-4 md:col-span-2">
                                ...
                                <textarea rows="5" name="address" id="address"
                                    class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">{{ old('address') }}</textarea>
                                @error('address')
                                    <p class="text-sm text-red-600 dark:text-red-400 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4 md:col-span-2">
                                ...
                                <img id="preview-image" class="mt-4 w-48 max-h-48 rounded object-cover"
                                    alt="Image Preview" src="{{ asset('default.png') }}">
                                @error('image')
                                    <p class="text-sm text-red-600 dark:text-red-400 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
